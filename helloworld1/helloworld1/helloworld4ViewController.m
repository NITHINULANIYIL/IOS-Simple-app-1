...
@interface helloworld4ViewController ()
...
- (void)viewDidLoad
{
    ...
    self.arrItems = [[NSMutableArray alloc]initWithObjects:@"Item 1",@"Item 2",@"Item3", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [button addTarget:self action:@selector(callLabel2) forControlEvents:UIControlEventTouchUpInside];
...
-(void)callLabel2{
    helloworld5ViewController *hello2 =[[helloworld5ViewController alloc]init];
